...
2. Run this command: `docker run --pull=always --restart always -it ghcr.io/placenl/placenl-bot ACCESS_TOKEN_HERE`
...
2. Start dit command: `docker run --pull=always --restart always -it ghcr.io/placenl/placenl-bot ACCESS_TOKEN_HIER`
